...
export class RegistrationComponent implements OnInit {
  ...
  contact: { mobilenumber: any, emailid: any, pincode: any,city: any,state: any,address: any, type:any, userid: any } = {mobilenumber:"",emailid:"",pincode:"",city:"",state:"",address:"",type: "CONTACT_INFO", userid: sessionStorage.getItem('userid')};
